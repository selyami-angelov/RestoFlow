    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OccupiedTables", x => new { x.TableId, x.UserId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_OccupiedTables_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OccupiedTables_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OccupiedTables_OrderId",
                table: "OccupiedTables",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OccupiedTables_UserId",
                table: "OccupiedTables",
                column: "UserId");
